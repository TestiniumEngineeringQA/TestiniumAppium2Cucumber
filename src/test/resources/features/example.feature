Feature: OpenApplication
  ...
  Scenario: BasicTiklamalarAndroidGratis00
    Given Wait 15 seconds
    Then Wait 2 seconds

  @BasicTiklamalarAndroidGratis02
  Scenario: BasicTiklamalarAndroidGratis02
    Given Wait 15 seconds
    Then Element with id "com.gratis.android:id/nav_graph_trademarks" is clicked
    Then Wait 2 seconds

  @BasicTiklamalarAndroidGratis03
  Scenario: BasicTiklamalarAndroidGratis03
    Given Wait 15 seconds
    Then Element with id "com.gratis.android:id/nav_graph_trademarks" is clicked
    Then Wait 2 seconds
    Then Element with id "com.gratis.android:id/nav_graph_categories" is clicked
  ...
  Scenario: BasicTiklamalarIOSAvita00
    Given Wait 15 seconds
    Then Wait 2 seconds

  @BasicTiklamalarIOSAvita02
  Scenario: BasicTiklamalarIOSAvita02
    Given Wait 15 seconds
